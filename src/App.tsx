...
import { Box, Container, Flex, Heading, SimpleGrid, Spinner, StylesProvider , Text } from "@chakra-ui/react";
          ...
          <div className="flex w-full max-w-xl flex-col gap-4 rounded-xl p-12 lg:border lg:border-gray-400 lg:dark:border-gray-800">
            ...
            <div className="flex w-full gap-4">
              {dropNotReady ? (
                ...
                {!address?(
                    <Text color={"white"} fontWeight={"bold"} backgroundColor={"whatsapp.800"} fontSize={"22px"}>Connect Your Wallet to Minting NFT</Text>
                    ):(
                    <Web3Button
                      contractAddress={
